        ...
        <ul class="bottom-nav-list">
            ...
            <li class="bottom-nav-item">
                <a href="<%= request.getContextPath() %>/" class="bottom-nav-link active">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bottom-nav-icon" viewBox="0 0 16 16">
            ...
            <li class="bottom-nav-item">
                <a href="#" class="bottom-nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bottom-nav-icon" viewBox="0 0 16 16">
                        <path d="M1 2a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1zM9 1h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1m4 8V6a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1M7 10V6a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1"/>
                    </svg>
