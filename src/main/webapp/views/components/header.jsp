...
<header class="navbar navbar-expand-lg header-navbar sticky-top">
    <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="search-container d-none d-lg-flex align-items-center">
            <!-- Home Button -->
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="header-nav-links d-none d-lg-flex align-items-center">
                ...
                <a href="#" class="install-app-link">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M8.5 6a.5.5 0 0 0-1 0v1.586l-.646-.647a.5.5 0 0 0-.708.708l1 1a.5.5 0 0 0 .708 0l1-1a.5.5 0 0 0-.708-.708L8.5 7.586V6z"/>
                    </svg>
                    Install App
                </a>
